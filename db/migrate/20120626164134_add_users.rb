...
def self.up
    ...
    def self.down
      remove_column :usuarios, :avatar_file_name
      remove_column :usuarios, :avatar_content_type
      remove_column :usuarios, :avatar_file_size
      remove_column :usuarios, :avatar_updated_at
    end
end
